...
//       setState(() {
//         _staffMembers = staff;
//         _regularMembers = List.from(widget.allMembers);
//         _isLoading = false;
//       });
//     } catch (e) {
//       setState(() => _isLoading = false);
...
//         _staffMembers.add(member);
//       });
//       _showSnack("${member['name']} promoted to staff ✅", Colors.blueAccent);
//     } catch (e) {
//       _showSnack("Error: $e", Colors.redAccent);
//     } finally {
...
//                 crossAxisAlignment: CrossAxisAlignment.start,
//                 children: [
//                   _sectionHeader("CURRENT STAFF", "${_staffMembers.length} members",
//                       Colors.blueAccent, Icons.badge_rounded),
//                   const SizedBox(height: 12),
//                   if (_staffMembers.isEmpty)
//                     _emptyHint("No staff members yet.\nPromote a member below.")
//                   else
...
//                         )),
//                   const SizedBox(height: 28),
//                   _sectionHeader("MEMBERS", "Tap to promote", Colors.white38,
//                       Icons.people_alt_rounded),
//                   const SizedBox(height: 12),
//                   if (_regularMembers.isEmpty)
//                     _emptyHint("All members are staff.")
...
//       padding: const EdgeInsets.all(14),
//       decoration: BoxDecoration(
//         color: isStaff ? Colors.blueAccent.withOpacity(0.06) : Colors.white.withOpacity(0.04),
//         borderRadius: BorderRadius.circular(14),
//         border: Border.all(
//           color: isStaff ? Colors.blueAccent.withOpacity(0.2) : Colors.white.withOpacity(0.05),
//         ),
//       ),
//       child: Row(
//         children: [
...
//                   (member['name'] as String)[0].toUpperCase(),
//                   style: TextStyle(
//                       color: isStaff ? Colors.blueAccent : Colors.yellowAccent,
//                       fontWeight: FontWeight.bold),
//                 ),
//               ),
//               if (isStaff)
...
//                   isStaff ? "Staff Member" : member['plan'] ?? 'Member',
//                   style: TextStyle(
//                       color: isStaff ? Colors.blueAccent : Colors.white38, fontSize: 11),
//                 ),
//               ],
//             ),
//           ),
...
//                       isStaff ? "REMOVE" : "PROMOTE",
//                       style: TextStyle(
//                           color: isStaff ? Colors.redAccent : Colors.blueAccent,
//                           fontSize: 10,
//                           fontWeight: FontWeight.bold,
//                           letterSpacing: 0.5),
//                     ),
